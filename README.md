# Prompt Engineering: First‑Party Guides & Cookbooks

This file is a curated collection of first-party prompting guides, documentation and cookbooks from leading AI organizations.

The goal is to bring scattered resources together for easier reference and pragmatic learning. It's not exhaustive.

Look at these resources as generalized, transferable examples that illustrate skills, patterns, and workflows rather than platform endorsement.

## Table of Contents

1. [First Party Resources](#first-party-resources)
	1. [OpenAI](#openai)
	...
	6. [AI21](#ai21)
	7. [Cohere](#cohere)
2. [Third Party Resources](#third-party-resources)
...
- https://www.llama.com/resources/cookbook/
